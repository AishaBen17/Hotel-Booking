                        ...
                        <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                            ...
                            <div className='flex flex-col md:flex-row'>
                                <img src={booking.room.images[0]}
                                    alt="hotel-img"
                                    className=' min-w-[11rem] md:w-44 rounded shadow object-cover' />
                                <div className='flex flex-col gap-1.5 max-md:mt-3 md:ml-4'>
                                    <p className='font-playfair text-2xl'> {booking.hotel.name} <span className='text-sm'>({booking.room.roomType})</span>
                                    </p>
                            ...
                            <div className='flex flex-col items-start justify-center pt-3'>
                                ...
                                {!booking.isPaid && (
                                    <button className='px-4 py-1.5 mt-4 text-xs border border-red-400 rounded-full hover:bg-red-50 transition-all cursor-pointer'>
                                        Pay Now
                                    </button>
                                )}
