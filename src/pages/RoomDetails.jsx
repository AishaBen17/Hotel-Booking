    ...
    return room && (
        <div className='  py-28 md:py-35 px-4 md:px-16 lg:px-28 xl:px-32'>
            ...
            <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
                <h1 className='text-3xl md:text-4xl font-playfair'>{room.hotel.name} <span className=' text-sm'>({room.roomType})</span>
                </h1>
                <p className='text-xs p-1.5 px-3 font-medium text-white bg-orange-500 rounded-full'>20% OFF</p>
            </div>
            {/* Room Raiting */}
            ...
            justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl">
                ...
                <button type='submit' className='bg-blue-600 hover:bg-blue-400 active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-24 py-3 md:py-4 text-base cursor-pointer'>
                    Check Availability
                </button>
            </form>
