    ...
    return (
        <div className=''>
            <Title align='left' font='outfit'
                title='Dashboard' subTitle='Monitor your room listings, track bookings and analyze revenue—all in one place. Stay updated with real-time insights to ensure smooth operations. ' />
            ...
            {/* Recent Bookings */}
            <h1 className='text-xl text-blue-900/70 font-medium mb-5'>Recent Bookings</h1>
